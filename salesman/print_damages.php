...
$checkCase = "SELECT * FROM {$prefix}case WHERE case_damages > 0";
...
$checkProd = "SELECT * FROM {$prefix}products WHERE damages > 0";
      ...
      <table class="table table-hover" id="tae">
        <thead>
          <tr>
            ...
            <th class="text-center">Case Damages</th>
          </tr>
        </thead>
        <tbody>
          ...
          while ($row = mysqli_fetch_array($execSelectCart)) {
            ...
            <tr>
              ...
              <td class="text-center"><?php echo $case_damages; ?></td>
            </tr>
        ...
        <table class="table table-hover" id="tae">
         <thead>
           <tr>
             ...
             <th class="text-center">Product damages</th>
           </tr>
         </thead>
         <tbody>
           ...
           while ($row = mysqli_fetch_array($execSelectCart)) {
             ...
             <tr>
               ...
               <td class="text-center"><?php echo $damages; ?></td>
             </tr>
