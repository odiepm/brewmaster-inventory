...
<div class="col-md-12">
  ...
  <div class="panel-body">
   <a href="print_damages.php" class="btn btn-default pull-right btn-md"><i class="glyphicon glyphicon-print"></i> Print List</a>
   <h4>Product List:</h4>
   <table class="table table-bordered table-striped table-hover results table-condensed" id="example">
    ...
    <tbody>
      ...
      $orderQuery = "SELECT * FROM {$prefix}products;";
