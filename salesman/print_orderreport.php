    ...
    <div class="container">
      ...
      <table class="table table-hover table-striped table-condensed">
       ...
       <tbody>
         ...
         $sqlSelect2 =  "SELECT * FROM {$prefix}reports WHERE report_date = '$listDate' ORDER BY report_id desc;";
      ...
      <hr>
     <a href="orders_today.php" class="btn btn-default btn-lg no-print">Back</a>
