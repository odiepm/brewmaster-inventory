    ...
    foreach($_POST['qtyBuy'] as $index=>$value){ 
     if($value > 0){
      ...
      //POST for Product List
          ...
          customer_product_price, customer_product_des, customer_info_id, customer_isEmpty)
          VALUES 
          ($count ,$swsID, '$custName', '$custAddress', '$custNumber', $sws_productid, '$sws_procode',
          '$sws_proname', '$case_sws_proexp', $value, $sws_unitprice, '$sws_prodesc', $customer_id, $sws_isEmpty)";
