  ...
  <div class="col-md-12">
    ...
    <div class="well well-sm">
      <ol class="breadcrumb" style="margin-bottom: -3px;">
        ...
        <li><strong>Completed Requests</strong> <span class="badge" style="background-color:#468847"><?php echo $fromComplete; ?></span></li>
        ...
        <table class="table table-condensed table-hover table-bordered table-striped" id="example">
          ...
          <tbody>
            <?php 
              ...
              $sql = "SELECT DISTINCT * FROM stock_transfer WHERE transfer_frombranch = '$capitalPrefix' AND transfer_status = 'Transfer Complete' GROUP BY (transfer_number);";
