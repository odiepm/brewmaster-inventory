  ...
  <div class="col-md-12">
    ...
    <div class="well well-sm">
      <ol class="breadcrumb" style="margin-bottom: -3px;">
        ...
        <li><a href="stock_requests_partial.php">Partially Transfered Requests</a></strong> <span class="badge" style="background-color:#f89406"><?><?php echo $toProgress; ?></span>
        </li>
        <li><strong>Completed Requests</strong><span class="badge" style="background-color:#468847"><?php echo $toComplete; ?></span></li>
        ...
        <table class="table table-condensed table-hover table-bordered table-striped" id="example">
          ...
          <tbody>
            <?php 
              ...
              AND transfer_status = 'Transfer Complete' GROUP BY (transfer_number);";
